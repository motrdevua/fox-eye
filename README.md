...
* [ ] Додати функцію збереження маркерів у файл (JSON), щоб не втрачати їх після перезавантаження сторінки?
...
* [ ] **Чи хочеш, щоб я тепер подивився на функцію `printMap`?** Я помітив у коді, що вона перемикає шари, і там теж можна додати перевірку, щоб вона не "падала", якщо карта ще не ініціалізована.
* [ ] Наступним кроком можемо підправити  **лінійку** , щоб вона автоматично прилипала до маркерів?
