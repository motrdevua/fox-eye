export const ICONS = {
  ...
  astro: `<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M12 22c5.52 0 10-4.48 10-10S17.52 2 12 2 2 6.48 2 12s4.48 10 10 10zm0-18c4.41 0 8 3.59 8 8s-3.59 8-8 8-8-3.59-8-8 3.59-8 8-8z"/><path d="M12 6v12c3.31 0 6-2.69 6-6s-2.69-6-6-6z"/></svg>`,
};
